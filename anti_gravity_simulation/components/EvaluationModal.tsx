...
import { Star, X, TrendingUp, AlertTriangle, CheckCircle } from 'lucide-react';
...
export const EvaluationModal: React.FC<EvaluationModalProps> = ({ isOpen, onClose, evaluation, scenarioTitle }) => {
